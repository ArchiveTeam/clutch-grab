...
LUA_SHA1 = get_hash(os.path.join(CWD, 'clutch.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'clutch-dld-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('clutch-item: %(item_name)s'),
...
project = Project(
    title = 'Clutch',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://www.archiveteam.org/images/2/2d/Clutch-icon.png" height="50px"/>
    <h2>clutch.win <span class="links"><a href="https://clutch.win/">Website</a> &middot; <a href="http://tracker.archiveteam.org/clutch/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='clutch'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
